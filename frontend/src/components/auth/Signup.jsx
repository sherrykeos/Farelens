...
const Signup = () => {
    ...
    return (
        <div className="fixed inset-0 z-10 overflow-hidden flex items-center justify-between gap-4 sm:gap-6 px-4 sm:px-12 lg:px-24 py-6">
            {/* Same rotated-photo background as Login — source photo is portrait (736x920),
                rotated -90deg to fill this landscape page, sized in vmax + centered via
                translate so it always covers the viewport on any screen size. */}
            <img
                src="/Image/Auth.jpg"
                alt=""
                className="absolute"
